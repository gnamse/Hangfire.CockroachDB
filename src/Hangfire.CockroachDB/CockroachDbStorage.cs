...
namespace Hangfire.PostgreSql
{
  public class CockroachDbStorage : JobStorage
  {
    ...
    public PersistentJobQueueProviderCollection QueueProviders { get; set; }
    ...
    /// See https://github.com/frankhommers/Hangfire.CockroachDb/issues/221
    /// </summary>
    /// <param name="connectionStringBuilder">The ConnectionStringBuilder to set the Timezone property for</param>
    public static void SetTimezoneToUtcForNpgsqlCompatibility(NpgsqlConnectionStringBuilder connectionStringBuilder)
    {
    ...
    public void UseTransaction(DbConnection dedicatedConnection,
    ...
    public T UseTransaction<T>(DbConnection dedicatedConnection,
    ...
    public void UseConnection(DbConnection dedicatedConnection, [InstantHandle] Action<DbConnection> action)
    {
    ...
    public T UseConnection<T>(DbConnection dedicatedConnection, Func<DbConnection, T> func)
    {
