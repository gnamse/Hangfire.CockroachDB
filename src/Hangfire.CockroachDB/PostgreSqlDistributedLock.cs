...
namespace Hangfire.PostgreSql
{
  public sealed class PostgreSqlDistributedLock
  {
    ...
    public static void Acquire(IDbConnection connection, string resource, TimeSpan timeout, PostgreSqlStorageOptions options)
    {
      if (connection == null)
      {
    ...
    public static void Release(IDbConnection connection, string resource, PostgreSqlStorageOptions options)
    {
      if (connection == null)
      {
        throw new ArgumentNullException(nameof(connection));
